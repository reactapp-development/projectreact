    ...
    <div className="min-h-screen bg-[#08111f] flex justify-center items-center p-4 pt-10">
      <div className="w-full sm:w-11/12 md:w-4/5 lg:w-3/5 min-h-[80vh] bg-white rounded-xl overflow-hidden flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 p-6 text-black">
          <div className="mb-8">
            <h1 className="font-semibold text-2xl sm:text-3xl mt-4">
              Welcome Back!
            </h1>
          ...
          <form>
            ...
            <div className="mb-5 text-sm">
              ...
              <input
                className="w-full mt-2 border border-gray-500 p-3 rounded-lg outline-none"
                type="email"
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 text-sm">
            ...
            <Link
              to="/forgot"
              className="text-blue-500 underline active:text-purple-600"
            >
              Forgot Password?
            </Link>
          </div>
          ...
          <button
            onClick={handleNext}
            className="w-full bg-black text-white font-semibold mt-8 py-3 rounded-2xl active:bg-gray-500"
          >
            Login
          </button>
          ...
          <div className="flex flex-wrap justify-center text-center text-sm">
            ...
            <Link
              to="/account"
              className="ml-1 text-blue-600 font-semibold active:text-purple-700"
            >
              Create new account
            </Link>
          </div>
