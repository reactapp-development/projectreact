    ...
    <div className="bg-[#08111f] w-full min-h-screen text-white sm:overflow-x-hidden md:overflow-x-hidden">
      ...
      <div className="text-center px-4">
        ...
        <motion.h1
          ...
          className="text-3xl sm:text-4xl md:text-5xl py-10 font-bold text-blue-400 hover:text-yellow-300 mt-10"
        >
          Explore Our Destinations
        </motion.h1>


        <p className="w-full sm:w-[80%] md:w-[60%] lg:w-[50%] mx-auto text-gray-300">
          ...
          >
            ...
            >
              ...
              <img
                ...
                className="object-cover w-full h-[35vh] sm:h-[45vh] md:h-[50vh] transition duration-700 group-hover:scale-110 opacity-80"
              />


              <div className="p-5">

                <h2 className="text-xl sm:text-2xl font-semibold text-yellow-200 hover:text-blue-300">
                  {destination.name}
                </h2>
